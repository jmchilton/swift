...
public final class IsotopicDistributionTest {
	...
	public void shouldAddDistributions() {
		...
		final Chemical water = new Chemical("H20", pt);
		final MassIntensityArray a = new MassIntensityArray();
		final IsotopicDistribution empty = new IsotopicDistribution(water.getMonoisotopicMass(), water, a);
		...
		final IsotopicDistribution d = new IsotopicDistribution(water.getMonoisotopicMass(), water, a);
		...
		final IsotopicDistribution e = new IsotopicDistribution(water.getMonoisotopicMass(), water, b);

		final IsotopicDistribution d_plus_e_frac_0 = d.add(e, 0, 0);
		Assert.assertEquals(d_plus_e_frac_0.toString(), "20.156500641999997 2.0 mono\n21.163777101999997 4.0 max\n22.171053561999997 3.0\n", "1*d + 0*e fail");

		final IsotopicDistribution d_plus_e_frac_1 = d.add(e, 1, 0);
		Assert.assertEquals(d_plus_e_frac_1.toString(), "20.156500641999997 1.0 mono\n21.163777101999997 3.0\n22.171053561999997 6.0 max\n", "0*d + 1*e fail");

		final IsotopicDistribution d_plus_e_frac_half = d.add(e, 0.5, 0);
		...
		final IsotopicDistribution e1 = new IsotopicDistribution(water.getMonoisotopicMass(), water, b);
		Assert.assertEquals(e1.toString(), "20.156500641999997 1.0 mono\n21.163777101999997 3.0\n22.171053561999997 6.0\n23.178330021999997 7.0 max\n", "e + one more isotope");

		final IsotopicDistribution d_plus_e1_frac_half = d.add(e1, 0.5, 0);
		Assert.assertEquals(d_plus_e1_frac_half.toString(), "20.156500641999997 1.5 mono\n21.163777101999997 3.5\n22.171053561999997 4.5 max\n23.178330021999997 3.5\n", "0.5d + 0.5e1 fail");

		final IsotopicDistribution e1_plus_d_frac_half = e1.add(d, 0.5, 0);
	...
	public void shouldAddWithTolerance() {
		...
		final double shift = d.getTheoreticalMonoisotopicMZ() * ppm / 1E6;
		final IsotopicDistribution d2 = d.copy(d.getTheoreticalMonoisotopicMZ() + shift, shift, 1.0);

		final IsotopicDistribution sum = d.add(d2, 0.5, ppm + 1E-10); // We use PPM slightly above the shift. All peaks should match
		...
		final IsotopicDistribution sum2 = d.add(d2, 0.5, ppm * 0.9); // We use PPM below the shift. No peaks should match
		...
		final IsotopicDistribution sum3 = d.add(d2, 0.5, shift / (water.getMonoisotopicMass() + 2 * pt.getProtonMass()) * 1E6 + 1E-6);
	...
	public void shouldCopy() throws CloneNotSupportedException {
		...
		final IsotopicDistribution copyOfD = d.copy(d.getTheoreticalMonoisotopicMZ() + 10, 10, 2);
	...
	public void shouldSupportExtraPeaks() throws CloneNotSupportedException {
		...
		final Chemical water = new Chemical("H20", pt);
		{
			...
			a.add(102, 100); // max
			a.add(103, 30);
			final IsotopicDistribution d = new IsotopicDistribution(100.2, water, a);
...

		{
			...
			a.add(102, 30);
			a.add(103, 30);
			final IsotopicDistribution d = new IsotopicDistribution(100.2, water, "Water", 0.1, 3, a);
...

		{
			...
			a.add(103, 30);
			final IsotopicDistribution d = new IsotopicDistribution(101.7, water, "Water", 0.1, 3, a);
...

		{
			...
			a.add(102, 100); // mono max
			a.add(103, 30);
			final IsotopicDistribution d = new IsotopicDistribution(101.7, water, "Water", 0.5, 0, a);
...

		{
			...
			a.add(102, 100); // mono max
			a.add(103, 30);
			final IsotopicDistribution d = new IsotopicDistribution(101.7, water, "Water", 0.5, 1, a);
...

		{
			...
			a.add(106, 20);
			a.add(107, 10);
			final IsotopicDistribution d = new IsotopicDistribution(101.1, water, "Water", 0.35, 0, a);
...

		{
			...
			a.add(100, 100); // max
			a.add(101, 30);
			final IsotopicDistribution d = new IsotopicDistribution(97, water, "Water", 0.1, 0, a);
