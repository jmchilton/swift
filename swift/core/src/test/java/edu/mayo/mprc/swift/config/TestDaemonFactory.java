...
public final class TestDaemonFactory {
	...
	public void shouldCreateDaemon() {
		ApplicationConfig config = createSwiftConfig();

		Daemon.Factory daemonFactory = TestApplicationContext.getDaemonFactory();
		Daemon daemon = daemonFactory.createDaemon(config.getDaemonConfig("main"));
		daemon.start();
	}
	...
	public void shouldSaveAndLoad() throws IOException, SAXException {
		...
		String savedFileContents = Files.toString(tempFile, Charsets.UTF_8);
	...
	private static ApplicationConfig createSwiftConfig() {
		...
		DaemonConfig main = new DaemonConfig();
		main.setName("main");
		...
		ServiceConfig mascot = new ServiceConfig("mascot", runner, BROKER_URI + "mascot");
		...
		ServiceConfig mascotDeployer = new ServiceConfig("mascotDeployer", runner8, BROKER_URI + "mascotDeployer");
		...
		ServiceConfig omssa = new ServiceConfig("omssa", runner2, BROKER_URI + "omssa");
		...
		ServiceConfig omssaDeployer = new ServiceConfig("omssaDeployer", runner9, BROKER_URI + "omssaDeployer");
		...
		ServiceConfig sequest = new ServiceConfig("sequest", runner22, BROKER_URI + "sequest");
		...
		ServiceConfig sequestDeployer = new ServiceConfig("sequestDeployer", runner33, BROKER_URI + "sequestDeployer");
		...
		ServiceConfig tandem = new ServiceConfig("tandem", runner338, BROKER_URI + "tandem");
		...
		ServiceConfig tandemDeployer = new ServiceConfig("tandemDeployer", runner331, BROKER_URI + "tandemDeployer");
		...
		ServiceConfig scaffold = new ServiceConfig("scaffold", runner3, BROKER_URI + "scaffold");
		...
		ServiceConfig scaffoldReport = new ServiceConfig("scaffoldReport", runner34, BROKER_URI + "scaffoldReport");
		...
		ServiceConfig qa = new ServiceConfig("qa", runner35, BROKER_URI + "qa");
		main.addService(qa);
		...
		ServiceConfig scaffoldDeployer = new ServiceConfig("scaffoldDeployer", runner11, BROKER_URI + "scaffoldDeployer");
		...
		ServiceConfig msmsEval = new ServiceConfig("msmsEval", runner4, BROKER_URI + "msmsEval");
		...
		ServiceConfig raw2mgf = new ServiceConfig("raw2mgf", runner5, BROKER_URI + "raw2mgf");
		...
		ServiceConfig peaks = new ServiceConfig("peaks", runner6, BROKER_URI + "peaks");
		...
		ServiceConfig peaksDeployer = new ServiceConfig("peaksDeployer", runner7, BROKER_URI + "peaksDeployer");
		...
		ServiceConfig mockMascotDeployer = new ServiceConfig("mockMascotDeployer", runner72, BROKER_URI + "mockMascotDeployer");
		...
		ServiceConfig qstat = new ServiceConfig("qstat", runner74, BROKER_URI + "qstat");
		...
		ServiceConfig mgfToMgf = new ServiceConfig("mgfToMgf", runner75, BROKER_URI + "mgfToMgf");
		...
		ServiceConfig rawDump = new ServiceConfig("rawDump", runner79, BROKER_URI + "rawDump");
		...
		ServiceConfig databasUndeployer = new ServiceConfig("databaseUndeployer", runner88, BROKER_URI + "databaseUndeployer");
		...
		final SwiftSearcher.Config searcherConfig = new SwiftSearcher.Config(
				...
				peaksDeployer, null, null, scaffold, scaffoldDeployer, null, null, scaffoldReport, qa, msmsEval, null);
		...
		ServiceConfig searcher = new ServiceConfig("searcher", runner76, BROKER_URI + "searcher");
