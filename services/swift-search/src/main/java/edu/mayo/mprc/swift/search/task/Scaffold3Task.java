...
final class Scaffold3Task extends AsyncTaskBase implements ScaffoldTaskI {
	...
	public Scaffold3Task(String experiment, SwiftSearchDefinition definition, DaemonConnection scaffoldDaemon, File outputFolder, FileTokenFactory fileTokenFactory, boolean fromScratch) {
	...
	public File getScaffoldSpectraFile() {
		return new File(outputFolder, experiment + AbstractScaffoldSpectraReader.EXTENSION);
	}
