...
public final class ScaffoldModificationFormat {
     ...
     */
    public LocalizedModList parseModifications(String sequence, String fixedMods, String variableMods) {
    ...
    private void addModifications(String modifications, Collection<LocalizedModification> mods, String sequence) {
