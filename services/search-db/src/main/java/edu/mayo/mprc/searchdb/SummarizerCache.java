...
final class SummarizerCache {
    ...
    SummarizerCache(ScaffoldModificationFormat format, ProteinSequenceTranslator translator) {
        this.format = format;
    ...
    public ProteinGroup getProteinGroup(BiologicalSample biologicalSample,
                                        ...
                                        String proteinAccessionNumbers,
        ...
        final ProteinGroupKey key = new ProteinGroupKey(biologicalSample, canonicalizedAccNums, databaseSources);
    ...
    private void addProteinSequences(String[] accNums, String databaseSources, ProteinGroup newProteinGroup) {
        ProteinSequenceList proteinSequences = new ProteinSequenceList(accNums.length);
        for (String accessionNumber : accNums) {
            proteinSequences.add(getProteinSequence(accessionNumber, databaseSources));
        }
    ...
    private ProteinSequence getProteinSequence(String accessionNumber, String databaseSources) {
