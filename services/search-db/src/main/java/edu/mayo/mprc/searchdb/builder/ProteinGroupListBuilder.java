...
public class ProteinGroupListBuilder implements Builder<ProteinGroupList> {
    ...
    public ProteinGroupListBuilder(SearchResultBuilder searchResult) {
        this.searchResult = searchResult;
    }

    @Override
    public ProteinGroupList build() {
        List<ProteinGroup> items = new ArrayList<ProteinGroup>(list.size());
        for (ProteinGroupBuilder builder : list.values()) {
    ...
    public ProteinGroupBuilder getProteinGroup(String proteinAccessionNumbers,
        ...
        BiologicalSampleBuilder biologicalSample = searchResult.getBiologicalSample();
    ...
    private void addProteinSequences(String[] accNums, String databaseSources, ProteinGroupBuilder newProteinGroup) {
        AnalysisBuilder analysis = searchResult.getBiologicalSample().getAnalysis();
    ...
    private void checkConsistencyWithinSample(BiologicalSampleBuilder biologicalSample, String column, int previousValue, int currentValue) {
        checkConsistencyWithinSample(biologicalSample, column, String.valueOf(previousValue), String.valueOf(currentValue));
    }

    private void checkConsistencyWithinSample(BiologicalSampleBuilder biologicalSample, String column, double previousValue, double currentValue) {
        checkConsistencyWithinSample(biologicalSample, column, String.valueOf(previousValue), String.valueOf(currentValue));
    }

    private void checkConsistencyWithinSample(BiologicalSampleBuilder biologicalSample, String column, String previousValue, String currentValue) {
