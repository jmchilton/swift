...
public class TestRawToMgf {
	...
	private void runRawToMgf(int spectrumBatchSize) {
		...
		File extractMsnFolder = Installer.extractMsn(null, Installer.Action.INSTALL);
		File unixXvfbWrapper = Installer.xvfbWrapper(null, Installer.Action.INSTALL);
		File rawFolder = Installer.rawFiles(null, Installer.Action.INSTALL);
